        ...
        VStack {
            ...
            Grid(alignment: .leading, verticalSpacing: 30) {
                Toggle(isOn: $viewModel.showImmersiveContent) {
                    Text("Show Diorama", comment: "Label for a toggle to show the diorama")
                }
                ...
                GridRow {
                    Text("Morph", comment: """
                                    Label for a slider that controls the level of morphing between \
                                    two geological formations that the diorama presents.
                                    """)
                ...
                GridRow {
                    Text("Scale", comment: "Label for a slider that controls the scale of the diorama.")
